        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <button class="btn btn-success btn-sm" @click="drawer = true" v-if="drawer==false" style="margin-bottom:10px;">Add Item</button>
                        <div class="row"  v-if="drawer===true">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span v-if="errors.category" :class="['badge badge-danger']">{{ errors.category[0] }}</span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span v-if="errors.price" :class="['badge badge-danger']">{{ errors.price[0] }}</span>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="">Tax</label>
                                    <input type="number" class="form-control" v-model="item.tax">
                                    <span v-if="errors.tax" :class="['badge badge-danger']">{{ errors.tax[0] }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody v-if="items.length > 0">
                                <tr v-for="it in items" :key="it.id">
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-info btn-sm" title="edit" @click="edit(it)">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" title="delete" @click="remove">
...
export default {
    ...
    methods:{
        ...
        save(){
            ...
            axios.post('/item/admod',this.item).then(
                response=>{
